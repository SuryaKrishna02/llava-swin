...
# Directory setup
DATA_DIR="/path/to/your/data"  # Replace with your actual data path
...
TRAIN_DATA="$DATA_DIR/train/{00000..99999}.tar"
TRAIN_NUM_SAMPLES=10000000  # Adjust to your dataset size
